 ...
 *
 *  This function handles the register write access to the PN51x as defined in the hardware specification.
 *  Interface handling (acknowledge, ...) is handled internally.
 *
 */
typedef phcsBfl_Status_t (*pphcsBflRegCtl_SetReg_t)     (phcsBflRegCtl_SetRegParam_t*);
 ...
 */
typedef phcsBfl_Status_t (*pphcsBflRegCtl_GetReg_t)     (phcsBflRegCtl_GetRegParam_t*);
 ...
 *  \retval  Other                             Depending on implementation and underlaying component.
 *
 * This function handles register bit modifications of the PN51x. Therefore a GetRegister command is 
 ...
 */
typedef phcsBfl_Status_t (*pphcsBflRegCtl_ModReg_t)     (phcsBflRegCtl_ModRegParam_t*);
 ...
 *  \retval  Other                             Depending on implementation and underlaying component.
 *
 *  This function handles the write access for multiple data bytes to one register of the PN51x. Depending 
 ...
 */
typedef phcsBfl_Status_t (*pphcsBflRegCtl_SetMultiReg_t)(phcsBflRegCtl_SetMultiRegParam_t*);
 ...
 *  \retval  Other                             Depending on implementation and underlaying component.
 *
 *  This function handles multiple read accesses for data bytes from one register adress of the PN51x. 
 ...
 */
typedef phcsBfl_Status_t (*pphcsBflRegCtl_GetMultiReg_t)(phcsBflRegCtl_GetMultiRegParam_t*);
...
/* //////////////////////////////////////////////////////////////////////////////////////////////
// Reg-Ctl Initialise for Serial Interface on PN51x:
*/
...
/* //////////////////////////////////////////////////////////////////////////////////////////////
// Reg-Ctl Initialise for I2C Interface on PN51x:
*/
/*! \ingroup i2c
...
/* //////////////////////////////////////////////////////////////////////////////////////////////
// Reg-Ctl Initialise for SPI Interface on PN51x:
*/
...
/* //////////////////////////////////////////////////////////////////////////////////////////////
// Reg-Ctl Initialise for Parallel Interface on PN51x:
*/
/*! \ingroup parallel
 *  \brief Parameter structure for parallel interface. Currently not used.
 */
typedef struct 
{
    /* For the current implementation we do not need any parameter. */
     uint8_t dummy;
} phcsBflRegCtl_ParaHw1Params_t;

/*!
* \ingroup parallel
* \param[in] *cif       C object interface structure
* \param[in] *p_params  Pointer to the internal operation variables.
* \param[in] *p_lower   Pointer to the underlying layer, in this case phcsBfl_Bal.
* 
* This function shall be called first to initialise the register control component for the parallel 
* interface. There the C-Layer, the internal variables and the underlaying layer are initialised.
* An own function pointer is typedef'ed for this function to enable the call within
* a generic C++ Reg-Ctl wrapper. This C++ wrapping can be found in INCRCREGCTL.H .
*
*/
void      phcsBflRegCtl_ParaHw1Init(phcsBflRegCtl_t  *cif,
                                  void           *p_params,
                                  phcsBflBal_t     *p_lower);
