 ...
 */
typedef uint16_t phcsBfl_Status_t;
...
#define PH_ERR_BFL_TEMP_ERROR              (0x0073)  /*!< \brief Temperature error indicated by PN51x HW.*/
/*@}*/
...
#define PH_ERR_BFL_USER_ERROR1             (0x0080)  /*!< \brief 1st User Error message.     */
/*@}*/
...
/*@{*/
/*! \ingroup error */
#define PH_ERR_BFL_COMP_MASK               (0xFF00)  /*!< \brief Mask to check only the layer identifier, not the error code. */
#define PH_ERR_BFL_ERR_MASK                (0x00FF)  /*!< \brief Mask to check only error code and not layer identifier. */
